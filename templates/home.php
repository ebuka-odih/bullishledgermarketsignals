...
<section class="py-6 bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-4">
            <a style="background-color: #4cabf7;" href="https://t.me/bullishledgermarketbot" target="_blank" class="block w-full text-white font-extrabold uppercase tracking-wider py-3 px-8 rounded-lg text-xl flex items-center justify-center transition-colors">
